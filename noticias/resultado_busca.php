	...
	<div id="tudo">
	  ...
	  <div id="cinza2">&nbsp;</div>
     	   <div id="not_tipo">
	          ...
	          <div class="center" id="titulo">Resultado da busca para &quot;Crit&eacute;rio&quot;</div>
		  </div>
...
da noticia . </div></div>
          ...
          <div class="texto_rotulo" id="aviso">"Não Existem Registros no Banco de Dados para este critério"&nbsp;</div>
          
          
          <div id="espacodois">&nbsp;</div>  
